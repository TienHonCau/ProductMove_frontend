# ProductMove
ProductionMove là phần mềm được sử dụng để theo dõi vòng đời các sản phẩm . Các cơ sở sản xuất, đại lý phân phối, trung tâm bảo hành đều sử dụng ProductionMove để cộng tác trong việc phân phối và theo dõi vòng đời của sản phẩm.
